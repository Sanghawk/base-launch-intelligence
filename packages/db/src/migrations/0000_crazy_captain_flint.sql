...
ALTER TABLE "tokens" ADD CONSTRAINT "tokens_deployer_id_deployers_id_fk" FOREIGN KEY ("deployer_id") REFERENCES "public"."deployers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "alerts_created_at_idx" ON "alerts" USING btree ("created_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "alerts_token_created_at_idx" ON "alerts" USING btree ("token_id","created_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "deployer_history_snapshots_deployer_observed_at_idx" ON "deployer_history_snapshots" USING btree ("deployer_id","observed_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "market_snapshots_token_observed_at_idx" ON "market_snapshots" USING btree ("token_id","observed_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "market_snapshots_pool_observed_at_idx" ON "market_snapshots" USING btree ("pool_id","observed_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "pools_base_token_id_idx" ON "pools" USING btree ("base_token_id");--> statement-breakpoint
CREATE INDEX "risk_checks_token_observed_at_idx" ON "risk_checks" USING btree ("token_id","observed_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "source_observations_entity_fetched_idx" ON "source_observations" USING btree ("source","entity_type","entity_key","fetched_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "token_scores_token_scored_at_idx" ON "token_scores" USING btree ("token_id","scored_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "token_scores_scored_at_idx" ON "token_scores" USING btree ("scored_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "tokens_first_seen_at_idx" ON "tokens" USING btree ("first_seen_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "tokens_deployer_id_idx" ON "tokens" USING btree ("deployer_id");--> statement-breakpoint
CREATE INDEX "worker_runs_started_at_idx" ON "worker_runs" USING btree ("started_at" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "worker_runs_status_started_at_idx" ON "worker_runs" USING btree ("status","started_at" DESC NULLS LAST);